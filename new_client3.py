...
if __name__ == "__main__":
    trainloader = DataLoader(CustomDataset("datasets\client3_dataset.csv"), batch_size=32, shuffle=True)
    valloader = DataLoader(CustomDataset("datasets\client3_dataset.csv"), batch_size=32)
